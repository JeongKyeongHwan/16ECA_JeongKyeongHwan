...
print "expand(x+y, complex+Ture) =", expand(x + y, complex=True)

print "expand((cos(x+y), trig=Ture) =", expand(cos(x + y), trig=True)
...
# 그래프 그리기 관련 기능 등을 담고 있는 pylab모듈을 불러 들임
import pylab
...
print "integrate(-x**2*erf(x), x) =", integrate(-x ** 2 * erf(x), x)
